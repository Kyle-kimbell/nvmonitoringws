export default function DashboardApp() {
  const sensorPoints = [
    { id: 1, label: "Camera", pin: "Barn", value: "Online", status: "Active" },
    { id: 2, label: "Temperature", pin: "Field 3", value: "23.4°C", status: "Active" },
    { id: 3, label: "Humidity", pin: "Field 1", value: "61% RH", status: "Active" },
    { id: 4, label: "Equipment Runtime", pin: "Betsy", value: "14.2 hrs", status: "Off" },
    { id: 5, label: "Water Flow Rate", pin: "Field 2", value: "18.2 L/min", status: "Active" },
  ];
            ...
            {sensorPoints.map((point) => (
              ...
              >
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-1 text-3xl font-bold">{point.value}</p>
                </div>
              </div>
            ))}
          </div>
